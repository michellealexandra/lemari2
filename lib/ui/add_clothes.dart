...
class AddClothes extends StatefulWidget {
  ...
  const AddClothes({Key key, this.closets}) : super(key: key);
  @override
                ...
                child: TextField(
                  ...
                  onTap: () async {
                    var date = await showDatePicker(
                        ...
                        firstDate: DateTime(1900),
                        lastDate: DateTime(2100));
                    ctrlLaundryDate.text = date.toString().substring(0, 10);
                  },
                ),
              ),
              // Container(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState.validate() &&
                        ...
                        Clothes clothes = Clothes(
                            ...
                            "",
                            "");
                        await ClothesServices.addClothes(clothes, closet, imageFile)
                            .then((value) {
                          if (value == true) {
                        ...
                        ActivityServices.showToast("Please check form fields!");
                      }
                    },
                    child: Text(
                      "Add Clothes",
